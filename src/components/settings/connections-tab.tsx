          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-blue-800/80 dark:text-blue-300/80">
                מעכשיו הגבייה והפקת הקבלות הן באחריותך, על שם העסק שלך. הגדר/י את
                האופן שמתאים לך:
              </p>
              <ul className="text-xs text-blue-800/80 dark:text-blue-300/80 list-disc list-inside space-y-0.5">
                <li>
                  לתשלומי <strong>אשראי</strong> — חבר/י כאן מסוף סליקה (Cardcom).
                </li>
                <li>
                  ל<strong>מזומן / צ׳ק / העברה</strong> — הקבלה מופקת לפי הגדרות
                  העסק שלך: עוסק/ת פטור/ה מפיק/ה קבלה פנימית על שמך (ללא מסוף),
                  ועוסק/ת מורשה/ת דרך ספק חשבוניות שתחבר/י.
                </li>
              </ul>
              <p className="text-xs text-blue-800/80 dark:text-blue-300/80">
                ודא/י שסוג העסק ומספר העוסק שלך מעודכנים ב״עסק וקבלות״.
              </p>
              <Button
                size="sm"
                className="mt-1"
