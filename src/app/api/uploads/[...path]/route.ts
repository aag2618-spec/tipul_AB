...
export async function GET(
  ...
  try {
    ...
    if (pathStr.startsWith("support/")) {
      ...
      // M10.7: מסירים Unicode bidi-override characters
      // U+200E/F (LRM/RLM), U+202A-202E (embedding/override), U+2066-2069 (isolate)
      /* eslint-disable security/detect-bidi-characters */
      const originalFilename = rawFilename.replace(
        /[‎‏‪-‮⁦-⁩]/g,
        ""
      );
      /* eslint-enable security/detect-bidi-characters */
