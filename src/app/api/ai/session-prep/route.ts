...
כללים חשובים:
• כתוב בעברית בלבד
• כתוב בסגנון מקצועי ותמציתי
• אל תשתמש בפורמט Markdown כלל (ללא ###, ללא **, ללא כוכביות לעיצוב)
• השתמש בנקודות (•) לרשימות
• השתמש בשורות ריקות להפרדה בין סעיפים`;
}
...
• היה ספציפי ומעשי
• אל תשתמש בפורמט Markdown כלל (ללא ###, ללא **, ללא כוכביות לעיצוב)
• השתמש בנקודות (•) לרשימות ובמספרים לסעיפים
• השתמש בשורות ריקות להפרדה בין סעיפים`;
}
