...
const DEFAULT_QUESTIONS = [
  "מה הביא אותך לפנות עכשיו? מה הכי מציק לך בתקופה האחרונה?",
  "איך זה משפיע על היומיום שלך? (בית ומשפחה, עבודה/לימודים, שינה, מצב רוח)",
  "עד כמה זה מפריע לך ביומיום? (קל / בינוני / קשה מאוד)",
  "האם יש מחשבות שקשה איתן — ייאוש, תחושה שאין טעם, או מחשבות לפגוע בעצמך?",
  "האם קיבלת טיפול נפשי בעבר? אם כן — איזה, ומה עזר או לא עזר?",
  "האם את/ה נוטל/ת כיום תרופות כלשהן (כולל פסיכיאטריות)?",
  "מה היית רוצה שישתפר בעקבות הטיפול?",
];
